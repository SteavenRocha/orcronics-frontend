...
<template>
    <div class="space-y-10">
        ...
        <div class="bg-white rounded-xl border border-gray-200 overflow-hidden">
            ...
            <!-- TABLA -->
            <div class="overflow-y-auto max-h-[calc(100vh-326px)] table-scroll">
                <table class="w-full text-sm">
                    ...
                    <tbody class="divide-y divide-gray-100">
                        ...
                        <!-- LOADING -->
                        <UiTableSkeleton v-if="loading" :rows="10" :cols="4" />
                        ...
                        <tr v-else v-for="customer in filteredCustomers" :key="customer.id"
                            ...
                            <td class="px-6 py-4" @click.stop>
                                <div class="flex items-center justify-end gap-2">
                                    <UiIconButton :title="customer.is_active ? 'Desactivar' : 'Activar'"
                                        variant="warning" @click="toggleStatus(customer.id, customer.is_active)">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                                            viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
                                            stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-archive"
                                            aria-hidden="true">
