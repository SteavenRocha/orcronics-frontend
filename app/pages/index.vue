...
async function handleLogin() {
    ...
    try {
        await $fetch(`${apiBaseUrl}/users/login`, {
            method: 'POST',
            body: {
    ...
    <div class="min-h-screen flex">
        ...
        <div
            ...
            <div class="absolute bottom-6 z-10">
                <p class="text-white/60 text-xs">© 2026 Orcronics ERP</p>
            </div>
        </div>
                        ...
                        <div>
                            ...
                            <div class="relative">
                                ...
                                <input id="username" v-model="form.username" type="text" autocomplete="username"
                                    ...
                                    :class="errors.username ? 'border-red-400 focus:ring-red-400' : 'focus:ring-primary'" />
                            </div>
